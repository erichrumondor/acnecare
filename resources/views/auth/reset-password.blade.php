...
<head>
    ...
    <title>Reset Password — AcneCare</title>
...
<div class="auth-card">
    ...
    <div class="auth-sub">Buat password baru untuk akunmu.</div>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-3">
            ...
            <input id="email" type="email" name="email" class="form-control"
                   value="{{ old('email', $request->email) }}" required autofocus placeholder="nama@email.com">
        </div>
        <div class="mb-3">
